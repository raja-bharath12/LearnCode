...
export const COURSES = {
  1: {
    ...
    lang: "python",
    lessons: [
      { id: 1, module: "Getting Started", title: "Introduction to Python", contentPath: "/courses/1-python-for-beginners/lessons/1-introduction-to-python/content.md", starter: '# Your first Python program\nprint("Hello, World!")' },
      { id: 2, module: "Getting Started", title: "Variables & Data Types", contentPath: "/courses/1-python-for-beginners/lessons/2-variables-data-types/content.md", starter: '# Variables & Data Types\nname = "Alice"\nage = 25\nprint(f"Name: {name}, Age: {age}")' },
      { id: 3, module: "Getting Started", title: "Strings", contentPath: "/courses/1-python-for-beginners/lessons/3-strings/content.md", starter: '# Strings\ntext = "Python is Fun"\nprint(text.upper())\nprint(text[0:6])' },
      { id: 4, module: "Getting Started", title: "Numbers & Math", contentPath: "/courses/1-python-for-beginners/lessons/4-numbers-math/content.md", starter: '# Numbers & Math\na = 10\nb = 3\nprint("Add:", a + b)\nprint("Power:", a ** b)' },
      { id: 5, module: "Getting Started", title: "Input & Output", contentPath: "/courses/1-python-for-beginners/lessons/5-input-output/content.md", starter: '# Input & Output\nname = input("Enter your name: ")\nprint(f"Hello, {name}!")' },
      { id: 6, module: "Control Flow & Structures", title: "Conditional Statements (if/elif/else)", contentPath: "/courses/1-python-for-beginners/lessons/6-conditional-statements-if-elif-else/content.md", starter: '# Conditional Statements\nage = 18\nif age >= 18:\n    print("Adult")\nelse:\n    print("Minor")' },
      { id: 7, module: "Control Flow & Structures", title: "Loops (for & while)", contentPath: "/courses/1-python-for-beginners/lessons/7-loops-for-while/content.md", starter: '# Loops\nfor i in range(5):\n    print(f"Count: {i}")' },
      { id: 8, module: "Control Flow & Structures", title: "Lists", contentPath: "/courses/1-python-for-beginners/lessons/8-lists/content.md", starter: '# Lists\nfruits = ["apple", "banana"]\nfruits.append("cherry")\nprint(fruits)' },
      { id: 9, module: "Control Flow & Structures", title: "Tuples", contentPath: "/courses/1-python-for-beginners/lessons/9-tuples/content.md", starter: '# Tuples\npoint = (10, 20)\nprint(point[0])' },
      { id: 10, module: "Control Flow & Structures", title: "Dictionaries", contentPath: "/courses/1-python-for-beginners/lessons/10-dictionaries/content.md", starter: '# Dictionaries\nuser = {"name": "Raja", "age": 20}\nprint(user["name"])' },
      { id: 11, module: "Functions & Advanced", title: "Sets", contentPath: "/courses/1-python-for-beginners/lessons/11-sets/content.md", starter: '# Sets\ns = {1, 2, 2, 3}\nprint(s) # {1, 2, 3}' },
      { id: 12, module: "Functions & Advanced", title: "Functions", contentPath: "/courses/1-python-for-beginners/lessons/12-functions/content.md", starter: 'def greet():\n    print("Hello!")\n\ngreet()' },
      { id: 13, module: "Functions & Advanced", title: "Arguments & Return Values", contentPath: "/courses/1-python-for-beginners/lessons/13-arguments-return-values/content.md", starter: 'def add(a, b):\n    return a + b\n\nprint(add(5, 7))' },
      { id: 14, module: "Functions & Advanced", title: "Scope & Namespaces", contentPath: "/courses/1-python-for-beginners/lessons/14-scope-namespaces/content.md", starter: 'x = 10\ndef show():\n    global x\n    x = 20\n\nshow()\nprint(x)' },
      { id: 15, module: "Functions & Advanced", title: "Modules & Imports", contentPath: "/courses/1-python-for-beginners/lessons/15-modules-imports/content.md", starter: 'import math\nprint(math.sqrt(16))' },
      { id: 16, module: "Functions & Advanced", title: "File I/O", contentPath: "/courses/1-python-for-beginners/lessons/16-file-i-o/content.md", starter: '# File I/O example\nwith open("test.txt", "w") as f:\n    f.write("Hello World")' },
      { id: 17, module: "Functions & Advanced", title: "Exception Handling", contentPath: "/courses/1-python-for-beginners/lessons/17-exception-handling/content.md", starter: 'try:\n    x = 1/0\nexcept ZeroDivisionError:\n    print("Error!")' },
      { id: 18, module: "Functions & Advanced", title: "List Comprehensions", contentPath: "/courses/1-python-for-beginners/lessons/18-list-comprehensions/content.md", starter: 'nums = [1, 2, 3, 4]\nsquares = [x*x for x in nums]\nprint(squares)' },
      { id: 19, module: "Functions & Advanced", title: "Lambda Functions", contentPath: "/courses/1-python-for-beginners/lessons/19-lambda-functions/content.md", starter: 'add = lambda a, b: a + b\nprint(add(5, 3))' },
      { id: 20, module: "Object Oriented Programming", title: "Classes & Objects (OOP Intro)", contentPath: "/courses/1-python-for-beginners/lessons/20-classes-objects-oop-intro/content.md", starter: 'class Dog:\n    def speak(self):\n        print("Woof!")\n\nd = Dog()\nd.speak()' },
      { id: 21, module: "Object Oriented Programming", title: "Inheritance", contentPath: "/courses/1-python-for-beginners/lessons/21-inheritance/content.md", starter: 'class Animal:\n    def speak(self):\n        print("Sound")\n\nclass Dog(Animal):\n    def speak(self):\n        print("Bark")' },
      { id: 22, module: "Real World Python", title: "Python Standard Library", contentPath: "/courses/1-python-for-beginners/lessons/22-python-standard-library/content.md", starter: 'import random\nprint(random.randint(1, 100))' },
      { id: 23, module: "Real World Python", title: "Virtual Environments & pip", contentPath: "/courses/1-python-for-beginners/lessons/23-virtual-environments-pip/content.md", starter: '# Commands are run in terminal\n# pip install requests' },
      { id: 24, module: "Real World Python", title: "Project: Build a Calculator", contentPath: "/courses/1-python-for-beginners/lessons/24-project-build-a-calculator/content.md", starter: '# Final Project: Calculator\n# Implement your logic here' }
    ]
  },
  2: {
